...
function Utils.Functions.GiveVehicleKey(plate, vehicle)
    if not Config.VehicleKeySystem.active then return end
    if Config.VehicleKeySystem.script == "qb-vehiclekeys" and
        Utils.Functions.hasResource("qb-vehiclekeys") then
        ...
        exports["wais-npcdialog"]:addExtraDialog({
            ...
            options = {
                option1 = {
                    ...
                    trigger = "0r-delivery:Client:ToggleDeliveryJobDuty",
                    eventType = "client",
                    selected = false,
                },
                option2 = {
